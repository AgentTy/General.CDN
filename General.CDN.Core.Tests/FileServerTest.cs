...
namespace General.CDN.Core.Tests
{
    ...
    public class FileServerTest
    {
        ...
        {
            IFileServer server1 = new FileServerAzure("/Uploads/", "http://www.testdomain.com", null, UnitTestContext.AzureBucket);
            IFileQuery file1 = new FileQuery("Awesome.jpg", "Images");

            IFileServer server2 = new FileServerAzure("/Uploads/", "http://www.anotherdomain.com", null, UnitTestContext.AzureBucket);
